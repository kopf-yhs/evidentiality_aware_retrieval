...
def main():
    ...
    #save_dir = str(Path(args.predict_file).parent)

    eval_dataset = EmDataset(
        tokenizer, args.predict_file, args.max_q_len, args.max_c_len, args.is_query_embed, args.embed_save_path, preprocessed=args.preprocessed)
