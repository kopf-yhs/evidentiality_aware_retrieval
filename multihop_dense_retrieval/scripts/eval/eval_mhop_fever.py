...
"""
python eval_mhop_fever.py /PATH/data/fever/retrieval/dev_multi_evidence.txt index/fever.npy index/fever_corpus_id2doc.json logs/08-27-2020/fever-seed16-bsz96-fp16True-lr2e-05-decay0.0-warm0.1-valbsz3000-sharedTrue/checkpoint_best.pt --batch-size 100 --beam-size-1 2 --beam-size-2 10 --topk 20 --shared-encoder --model-name roberta-base --gpu --save-path dense_fever_b2_10_k20.json

# unified retrieval
python eval_mhop_fever.py /PATH/data/fever/retrieval/dev.txt index/fever_unified.npy index/fever_corpus_id2doc.json logs/08-30-2020/fever_unified_roberta-seed16-bsz96-fp16True-lr2e-05-decay0.0-adamTrue/checkpoint_best.pt --batch-size 100 --beam-size-1 1 --beam-size-2 20 --topk 20 --shared-encoder --model-name roberta-base --gpu --save-path dense_all_b1_k10_unified.json


python eval_mhop_fever.py /PATH/data/fever/retrieval/dev_multi_evidence.txt index/fever_unified.npy index/fever_corpus_id2doc.json logs/08-30-2020/fever_unified_roberta-seed16-bsz96-fp16True-lr2e-05-decay0.0-adamTrue/checkpoint_best.pt --batch-size 100 --beam-size-1 1 --beam-size-2 20 --topk 20 --shared-encoder --model-name roberta-base --gpu --save-path dense_multi_b1_k10_unified.json

# fix parenthesis
python eval_mhop_fever.py /PATH/data/fever/retrieval/multi_dev.txt index/fever_.npy index/fever_corpus_id2doc.json logs/08-27-2020/fever_-seed16-bsz96-fp16True-lr2e-05-decay0.0-warm0.1-valbsz3000-sharedTrue/checkpoint_best.pt --batch-size 100 --beam-size-1 1 --beam-size-2 20 --topk 20 --shared-encoder --model-name roberta-base --gpu --save-path dense_fever_b1_k20_fix_brc.json
...
if __name__ == '__main__':
    ...
    if args.save_path != "":
        with open(f"/PATH/data/fever/retrieval/{args.save_path}", "w") as out:
