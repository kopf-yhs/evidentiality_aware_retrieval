...
if __name__ == '__main__':
    ...
    if args.save_pred != "":
        ...
        save_path = Path(args.save_pred)
        save_path.mkdir(exists_ok=True)
        with open(save_path.joinpath('scores.json'), "w") as g:
            for l in to_save:
