...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_single.py \
    ...
    --learning_rate 2e-5 \
    --fp16 \
    --train_file /PATH/data/nq-dpr/nq-with-neg-train.txt \
    --predict_file /PATH/data/nq-dpr/nq-with-neg-dev.txt \
    --seed 16 \
    --eval-period -1 \
    --max_c_len 300 \
    --max_q_len 50 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_single.py \
    ...
    --learning_rate 2e-5 \
    --fp16 \
    --train_file /PATH/data/WebQ/wq-train-simplified.txt \
    --predict_file /PATH/data/WebQ/wq-dev-simplified.txt \
    --seed 16 \
    --eval-period -1 \
    --max_c_len 300 \
    --max_q_len 50 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_single.py \
    ...
    --learning_rate 2e-5 \
    --fp16 \
    --train_file /PATH/data/fever/retrieval/train_tfidf_neg.txt \
    --predict_file /PATH/data/fever/retrieval/dev_tfidf_neg.txt \
    --seed 16 \
    --eval-period -1 \
    --max_c_len 400 \
    --max_q_len 45 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_single.py \
    ...
    --learning_rate 2e-5 \
    --fp16 \
    --train_file /PATH/data/hotpot/hotpot_train_with_neg_v0.json \
    --predict_file /PATH/data/hotpot/hotpot_val_with_neg_v0.json \
    --seed 16 \
    --eval-period -1 \
    --max_c_len 300 \
    --max_q_len 70 \
